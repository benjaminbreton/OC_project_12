...
//                Text("Unity")
//                    .withTitleFont()
//                GenericPicker(title: "Unity", placeHolder: "Click here to choose an unity", data: unities, selectionIndex: selecte, selectedObjects: <#T##Binding<[_]>#>, maximumSelection: <#Int#>)
